# Waveshare product-image attribution

The product photographs in this directory are reproduced from Waveshare's
official product page to identify connection points on the
`ESP32-S3-POE-ETH-8DI-8RO` and explain installation.

Source:
[Waveshare ESP32-S3-POE-ETH-8DI-8RO product page](https://www.waveshare.com/esp32-s3-eth-8di-8ro.htm?sku=30838)
