...
1. Confirm the board and PixLite are listed in `compatibility.json`.
...
- PixLite model, firmware, negotiated API version, nickname, and MAC suffix.
...
Remove Wi-Fi, AP, web, and PixLite passwords. Do not post private network
